...
function AppInner() {
  ...
  const onLabs   = location.pathname === '/' || location.pathname.startsWith('/lab');
  const onTheory = location.pathname.startsWith('/theory');
    ...
    <div className="app-container">
      <header className="app-header">
        ...
        <nav className="app-nav-desktop">
          <Link to="/" className={onLabs ? 'active' : ''}>Labs</Link>
          <Link to="/theory" className={onTheory ? 'active' : ''}>Theory</Link>
      ...
      <nav className="bottom-tab-bar">
        <Link to="/" className={`bottom-tab ${onLabs ? 'active' : ''}`}>
          <Terminal size={22} />
          <span>Labs</span>
        </Link>
        <Link to="/theory" className={`bottom-tab ${onTheory ? 'active' : ''}`}>
          <BookOpen size={22} />
          <span>Theory</span>
        </Link>
        <a
